namespace Hqub.MusicBrainz.Services
{
    ...
    public interface ILabelService
    {
        ...
        /// <returns></returns>
        SearchRequest<Label> Search(string query, int limit = 25, int offset = 0);
        ...
        /// <param name="offset">Return search results starting at a given offset. Used for paging through more than one page of results (default = 0).</param>
        /// <returns></returns>
        SearchRequest<Label> Search(QueryParameters<Label> query, int limit = 25, int offset = 0);
        ...
        /// <param name="inc">A list of entities to include (sub-queries).</param>
        /// <returns></returns>
        BrowseRequest<Label> Browse(string entity, string id, int limit = 25, int offset = 0, params string[] inc);
        ...
        /// <param name="offset">Return search results starting at a given offset. Used for paging through more than one page of results (default = 0).</param>
        /// <returns></returns>
        Task<QueryResult<Label>> SearchAsync(string query, int limit = 25, int offset = 0);
        ...
        /// <param name="offset">Return search results starting at a given offset. Used for paging through more than one page of results (default = 0).</param>
        /// <returns></returns>
        Task<QueryResult<Label>> SearchAsync(QueryParameters<Label> query, int limit = 25, int offset = 0);
        ...
        /// <param name="inc">A list of entities to include (sub-queries).</param>
        /// <returns></returns>
        Task<QueryResult<Label>> BrowseAsync(string entity, string id, int limit = 25, int offset = 0, params string[] inc);
    }
}
